 ...
 * @Author: Abhishek 
 */
public class TYSS_Episodes_GE_003 extends BaseTest{

	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Episodes where Sl_No ='TC_Episodes_GE_003'")
	...
	public void TC_TYSS_Episodes_GE_003(String slNo,String methodType,String pathParam,String queryParamKey,String endpoint) {
		...
		ApiActionUtil.validateResponseBodyValue(response,prop_constants.getProperty("release_date"),prop_constants.getProperty("release_date"));
