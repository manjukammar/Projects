...
/*
 * TestCaseId:TC_Playlists_GPCI_004
 * TestScript Name: TYSS_TC_Playlists_GPCI_004
 * Description: "Verify that the response contains error when provided invalid format"
 * 
 * @Author: Shivananda T S 
 */
public class TYSS_TC_Playlists_GPCI_004 extends BaseTest {

	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from PlayList where Sl_No ='TYSS_TC_Playlists_GPCI_004'")
	...
	public void TC_Playlists_GPCI_004(String slNo, String methodType, String pathParam, String queryParamKey,
			String endpoint) {
