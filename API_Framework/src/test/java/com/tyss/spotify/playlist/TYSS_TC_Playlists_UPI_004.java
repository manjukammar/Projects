...
/*
 * TestCaseId: TC_Playlists_UPI_004
 * TestScript Name: TYSS_TC_Playlists_UPI_004
 * Description: Verify that the response contains error when incorrect endpoint is provided
 * 
 * @Author: Sanjay 
 */
public class TYSS_TC_Playlists_UPI_004 extends BaseTest {

	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Playlist where Sl_No ='TC_Playlists_UPI_004'")
	...
	public void TC_Playlists_UPI_004(String slNo, String methodType, String pathParam, String queryParamKey,
			String endpoint) {
		...
		ApiActionUtil.validateResponseBodyValue(response, prop_constants.getProperty("error.message"),
				prop_constants.getProperty("error.message"));
