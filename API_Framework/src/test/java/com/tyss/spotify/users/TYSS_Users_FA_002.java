...
/*
 * TestCaseId: TYSS_Users_FA_002
 * TestScript Name: TC_Users_FA_002
 * Description: Verify that the response contains error when provide invalid artist id.  
 * 
 * @Author: Manjappa 
 */

public class TYSS_Users_FA_002 extends BaseTest{
	
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Users where Sl_No ='Users_FA_002'")
	...
	public void TC_Users_FA_001(String slNo,String methodType,String pathParam,String queryParamKey,String endpoint) {

		/* Put request for follow artist */
		Response response = ApiActionUtil.putMethod(methodType, pathParam, queryParamKey, endpoint, jsonFilePath.getProperty("users_params_invalidId"),prop_constants.getProperty("null"));
