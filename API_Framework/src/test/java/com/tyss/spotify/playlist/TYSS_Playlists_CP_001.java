...
/*
 * TestCaseId: TYSS_Playlists_CP_001
 * TestScript Name: TC_Playlists_CP_001
 * Description: Verify the status code in response of playlist. 
 * 
 * @Author: Manjappa 
 */
public class TYSS_Playlists_CP_001 extends BaseTest{
	
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Playlist where Sl_No ='Playlists_CP_001'")
