...
/*
 * TestCaseId: TYSS_Users_GUTI_002
 * TestScript Name: TC_Users_GUTI_002
...
public class TYSS_Users_GUTI_002 extends BaseTest{
	
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Users where Sl_No ='Users_GUTI_002'")
	...
	public void TC_Users_GUTI_002(String slNo,String methodType,String pathParam,String queryParamKey,String endpoint) {
