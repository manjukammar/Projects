 ...
 * @Author: Abhishek 
 */
public class TYSS_Episodes_CUSE_002 extends BaseTest{
	
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Episodes where Sl_No ='TC_Episodes_CUSE_002'")
