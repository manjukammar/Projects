...
/*
 * TestCaseId: TC_Playlists_GPI_004
 ...
 */
public class TYSS_TC_Playlists_GPI_004 extends BaseTest {

	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from PlayList where Sl_No ='TYSS_TC_Playlists_GPI_004'")
	...
	public void TC_Playlists_GPI_004(String slNo, String methodType, String pathParam, String queryParamKey,
			String endpoint) {
