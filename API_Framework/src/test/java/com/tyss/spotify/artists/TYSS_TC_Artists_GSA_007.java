...
/*
 * TestCaseId: TC_Artists_GSA_007
 * TestScript Name: TYSS_TC_Artists_GSA_007
 * Description: Verify that the response contains error when provided incorrect artists endpoint
 * 
 * @Author: Sanjay 
 */
public class TYSS_TC_Artists_GSA_007 extends BaseTest{

	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Artists where Sl_No ='TC_Artists_GSA_007'")
	...
	public void TC_Artists_GSA_007(String slNo,String methodType,String pathParam,String queryParamKey,String endpoint) {
