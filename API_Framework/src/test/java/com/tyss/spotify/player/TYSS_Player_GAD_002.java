...
/*
 * TestCaseId: TC_Player_GAD_002
 * TestScript Name: TYSS_Player_GAD_002
 * Description: Verify that the API returns an error when the request format is invalid
 * 
 * @Author: Sreelatha 
 */
public class TYSS_Player_GAD_002 extends BaseTest {

	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Player where Sl_No ='TYSS_Player_GAD_002'")
	...
	public void TC_TYSS_Player_GAD_002(String slNo,String methodType,String pathParam,String queryParamKey,String endpoint) {
