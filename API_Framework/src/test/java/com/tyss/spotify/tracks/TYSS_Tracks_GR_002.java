...
/*
 * TestCaseId: TC_TYSS_Tracks_GR_002
 * TestScript Name: TYSS_Tracks_GR_002
 * Description:Verify that the API returns the correct data for each seed entity.
 * @Author: Abhishek 
 */
public class TYSS_Tracks_GR_002 extends BaseTest{

	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Tracks where Sl_No ='TC_Tracks_GR_002'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class, description = "Verify that the API returns the correct data for each seed entity.")
	public void TC_TYSS_Tracks_GR_002(String slNo,String methodType,String pathParam,String queryParamKey,String endpoint) {
