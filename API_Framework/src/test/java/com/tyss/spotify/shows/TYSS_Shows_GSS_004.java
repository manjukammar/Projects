...
/*
 * TestCaseId: TYSS_Shows_GSS_004
 * TestScript Name: TYSS_Shows_GSS_004
 * Description: Verify that the response contains error when provide wrong shows endpoint.
 * 
 * Author: Bredlin
 */
public class TYSS_Shows_GSS_004 extends BaseTest{
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Shows where Sl_No='TC_Shows_GSS_004'")
	...
	public void TC_TYSS_Shows_GSS_004(String testCase, String methodType, String pathParam, String queryParamKey, String endpoint) throws IOException, ParseException, Exception {
