...
/*
 * TestCaseId: Users_GCUP_001
 * TestScript Name: TC_Users_GCUP_001
 * Description: Verify that the response contains display name of the user  
 * 
 * @Author: Manjappa 
 */

public class TYSS_Users_GCUP_001 extends BaseTest{
	
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Users where Sl_No ='Users_GCUP_001'")
	...
	public void TC_Users_GCUP_001(String slNo,String methodType,String pathParam,String queryParamKey,String endpoint) {
