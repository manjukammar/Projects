 ...
 * Description:Verify that the API returns an error when too many seeds are provided in the same request.
 * @Author: Abhishek 
 */
public class TYSS_Tracks_GR_005 extends BaseTest{

	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Tracks where Sl_No ='TC_Tracks_GR_005'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class, description = "Verify that the API returns an error when too many seeds are provided in the same request.")
