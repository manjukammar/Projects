...
/*
 * TestCaseId: TC_Artists_GATT_006
 * TestScript Name: TYSS_TC_Artists_GATT_006
 * Description: Verify that the response contains error when provided incorrect path param
 * 
 * @Author: Sanjay 
 */
public class TYSS_TC_Artists_GATT_006 extends BaseTest{

	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Artists where Sl_No ='TC_Artists_GATT_006'")
	...
	public void TC_Artists_GATT_006(String slNo,String methodType,String pathParam,String queryParamKey,String endpoint) {
