...
/*
 * TestCaseId: TC_Tracks_GT_005
 * TestScript Name: TYSS_Tracks_GT_005
 * Description: Verify the response returns error when the request format is invalid.
 * 
 * Author: Bredlin
 */
public class TYSS_Tracks_GT_005 extends BaseTest{
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Tracks where Sl_No ='TC_Tracks_GT_005'")
	...
	public void TC_TYSS_Tracks_GT_005(String testCase, String methodType, String pathParam, String queryParamKey, String endpoint) throws IOException, ParseException, Exception {
