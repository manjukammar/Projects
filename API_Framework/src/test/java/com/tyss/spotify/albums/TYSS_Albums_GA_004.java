...
/*
 * TestCaseId: TC_Albums_GA_004
 * TestScript Name: TYSS_Albums_GA_004
 * Description: Verify that the API returns an error when the request format is invalid
 * 
 * Author: Sreelatha
 */
public class TYSS_Albums_GA_004  extends BaseTest {
	
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Albums where Sl_No ='TYSS_Albums_GA_004'")
	...
	public void TC_TYSS_Albums_GA_004(String Testcase_Id,String methodType,String pathParam,String queryParamKey,String endPoints) {
