...
/*
 * TestCaseId: TC_Playlists_GFP_004
 ...
 */
public class TYSS_TC_Playlists_GFP_005 extends BaseTest {

	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from PlayList where Sl_No ='TYSS_TC_Playlists_GFP_003'")
	...
	public void TC_Playlists_GFP_003(String slNo, String methodType, String pathParam, String queryParamKey,
			String endpoint) {
