...
/*
 * TestCaseId: TC_TYSS_Episodes_GE_004
 * TestScript Name: TYSS_Episodes_GE_004
 * Description:Verify that the response contains error when provide invalid episode id.
 * @Author: Abhishek 
 */
public class TYSS_Episodes_GE_004 extends BaseTest{

	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Episodes where Sl_No ='TC_Episodes_GE_004'")
	...
	public void TC_TYSS_Episodes_GE_004(String slNo,String methodType,String pathParam,String queryParamKey,String endpoint) {
