...
/*
 * TestCaseId:TC_Playlists_GFP_001
 * TestScript Name: TYSS_TC_Playlists_GFP_001
 * Description: "Verify the status code in response of playlist"
 * 
 * @Author: Shivananda T S 
 */
public class TYSS_TC_Playlists_GFP_001 extends BaseTest {

	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from PlayList where Sl_No ='TYSS_TC_Playlists_GFP_001'")
	...
	public void TC_Playlists_GFP_001(String slNo, String methodType, String pathParam, String queryParamKey,
			String endpoint) {
