...
/*
 * TestCaseId: TC_Playlists_GP_004
 * TestScript Name: TYSS_TC_Playlists_GP_001
 * Description: "Verify that the response contains error when  incorrect endpoint is provided"
 * 
 * @Author: Shivananda T S 
 */
public class TYSS_TC_Playlists_GP_004 extends BaseTest {

	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from PlayList where Sl_No ='TYSS_Playlists_GP_004'")
	...
	public void TYSS_Playlists_GP_004(String slNo, String methodType, String pathParam, String queryParamKey,
			String endpoint) {
