...
/*
 * TestCaseId: TC_Albums_GNR_005
 * TestScript Name: TYSS_Albums_GNR_005
 * Description: Verify the response returns error when request format is invalid.
 * 
 * Author: Bredlin
 */
public class TYSS_Albums_GNR_005 extends BaseTest{
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Albums where Sl_No='TC_Albums_GNR_005'")
	...
	public void TC_TYSS_Albums_GNR_005(String testCase, String methodType, String pathParam, String queryParamKey, String endpoint) throws IOException, ParseException, Exception {
