...
public class TYSS_Users_GUP_005 extends BaseTest{
	
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Users where Sl_No ='Users_GUP_005'")
	...
	public void TC_Users_GUP_005(String slNo,String methodType,String pathParam,String queryParamKey,String endpoint) {
