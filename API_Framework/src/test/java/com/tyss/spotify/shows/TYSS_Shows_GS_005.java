...
/*
 * TestCaseId: TC_TYSS_Shows_GS_005
 * TestScript Name: TYSS_Shows_GS_005
 * Description: Verify that the response contains error when provided wrong shows endpoint
 * 
 * @Author: Abhishek 
 */
public class TYSS_Shows_GS_005 extends BaseTest{
	
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Shows where Sl_No ='TC_Shows_GS_005'")
	...
	public void TC_TYSS_Shows_GS_005(String slNo,String methodType,String pathParam,String queryParamKey,String endpoint) {
