...
/*
 * TestCaseId: TC_Playlists_GPCI_003
 * TestScript Name: TYSS_TC_Playlists_GPCI_003
 * Description: "Verify that the response contains error when  incorrect playlist id is provided"
 * 
 * @Author: Shivananda T S 
 */
public class TYSS_TC_Playlists_GPCI_003 extends BaseTest {

	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from PlayList where Sl_No ='TYSS_TC_Playlists_GPCI_003'")
	...
	public void TC_Playlists_GPCI_003(String slNo, String methodType, String pathParam, String queryParamKey,
			String endpoint) {
