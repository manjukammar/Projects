...
/*
 * TestCaseId: TYSS_Users_FA_003
 * TestScript Name: TC_Users_FA_003
 * Description: Verify that the response contains error when provided invalid  end point.  
 * 
 * @Author: Manjappa 
 */

public class TYSS_Users_FA_003 extends BaseTest{
	
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Users where Sl_No ='Users_FA_003'")
	...
	public void TC_Users_FA_003(String slNo,String methodType,String pathParam,String queryParamKey,String endpoint) {
