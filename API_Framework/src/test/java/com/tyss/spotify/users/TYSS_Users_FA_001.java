...
/*
 * TestCaseId: TYSS_Users_FA_001
 * TestScript Name: TC_Users_FA_001
 * Description: Verify that the response contains  status code for given request.  
 * 
 * @Author: Manjappa 
 */

public class TYSS_Users_FA_001 extends BaseTest{
	
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Users where Sl_No ='Users_FA_001'")
