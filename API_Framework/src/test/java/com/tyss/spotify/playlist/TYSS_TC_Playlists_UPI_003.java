...
/*
 * TestCaseId: TC_Playlists_UPI_003
 * TestScript Name: TYSS_TC_Playlists_UPI_003
 * Description: Verify that the response contains error when incorrect path param is provided
 * 
 * @Author: Sanjay 
 */
public class TYSS_TC_Playlists_UPI_003 extends BaseTest{

	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Playlist where Sl_No ='TC_Playlists_UPI_003'")
	...
	public void TC_Playlists_UPI_003(String slNo,String methodType,String pathParam,String queryParamKey,String endpoint) {
