...
/*
 * TestCaseId:TC_Playlists_GPI_003
 ...
 */
public class TYSS_TC_Playlists_GPI_003 extends BaseTest {

	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from PlayList where Sl_No ='TYSS_TC_Playlists_GPI_003'")
	...
	public void TYSS_Playlists_GPI_003(String slNo, String methodType, String pathParam, String queryParamKey,
			String endpoint) {
