...
/*
 * TestCaseId:TC_Playlists_GFP_002
 * TestScript Name: TYSS_TC_Playlists_GFP_002
 * Description: "Verify that the response returns the playlist for the provided playlist id."
 * 
 * @Author: Shivananda T S 
 */
public class TYSS_TC_Playlists_GFP_002 extends BaseTest {

	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from PlayList where Sl_No ='TYSS_TC_Playlists_GFP_002'")
	...
	public void TC_Playlists_GFP_002(String slNo, String methodType, String pathParam, String queryParamKey,
			String endpoint) {
