...
/*
 * TestCaseId: TYSS_Users_CUFP_002
 * TestScript Name: TC_Users_CUFP_002
 * Description: Verify that the response contains error when provide invalid  end point. 
 * 
 * @Author: Manjappa 
 */

public class TYSS_Users_CUFP_002 extends BaseTest{
	
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Users where Sl_No ='Users_CUFP_002'")
