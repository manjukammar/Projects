...
/*
 * TestCaseId: TC_Playlists_GP_001
 * TestScript Name: TYSS_Playlists_GP_001
 * Description: "Verify that the response returns the playlist for the provided playlist id."
 * 
 * @Author: Shivananda T S 
 */
public class TYSS_TC_Playlists_GP_001 extends BaseTest {

	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from PlayList where Sl_No ='TYSS_Playlists_GP_001'")
	...
	public void TYSS_Playlists_GP_001(String slNo, String methodType, String pathParam, String queryParamKey,
			String endpoint) {
		...
		String ids = ApiActionUtil.getResponseBodyValue(response, prop_constants.getProperty("playlist.id"));
